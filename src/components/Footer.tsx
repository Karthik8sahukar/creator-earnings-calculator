  ...
  return (
    <footer className="mt-20 border-t border-slate-200/70 bg-white/60">
      <div className="container-page py-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-4 text-sm text-slate-600">
        <div>
          <h3 className="font-semibold text-slate-900">{publicConfig.siteName}</h3>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2">
            ...
            <li><Link href="/disclaimer" className="hover:text-slate-900">Disclaimer</Link></li>
      ...
      <div className="container-page pb-8 text-xs text-slate-500">
        &copy; {new Date().getFullYear()} {publicConfig.siteName}. Independent tool.
      </div>
    </footer>
  );
}
