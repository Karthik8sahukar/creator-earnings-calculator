...
export default async function Page() {
  return (
    <>
      ...
      <ToolSEO pathSuffix={PATH} toolName="YouTube Membership Revenue Calculator" toolDescription="Estimate YouTube channel membership revenue based on subscribers, conversion rate, and pricing tiers." applicationCategory="FinanceApplication" faq={FAQ} breadcrumbName="Membership Calculator" />
    </>
  );
}
