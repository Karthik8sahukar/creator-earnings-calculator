...
export default async function Page({ params }: { /* no params */ }) {
  return (
    <>
      ...
      <ToolSEO pathSuffix={PATH} toolName="YouTube Merch Revenue Calculator" toolDescription="Estimate YouTube merchandise revenue based on views, conversion rate, and profit margin." applicationCategory="FinanceApplication" faq={FAQ} breadcrumbName="Merch Calculator" />
    </>
  );
}
