...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { type: "website", title: "Developer Tools – Free Browser-Based Utilities", description: "Free browser-based developer tools. No data leaves your device.", url: `${publicConfig.siteUrl}/${locale}${PATH}`, siteName: publicConfig.siteName, locale },
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <>
      <DeveloperToolsGrid />
      <ToolSEO locale={locale} pathSuffix={PATH} toolName="Developer Tools" toolDescription="Collection of free browser-based developer utilities." faq={FAQ} breadcrumbName="Developer Tools" />
    </>
  );
}
