...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { type: "website", title: "Dice Roller — Roll Any Dice Online Free", description: "Roll virtual dice from d4 to d100.", url: `/${locale}${PATH}`, siteName: publicConfig.siteName, locale },
