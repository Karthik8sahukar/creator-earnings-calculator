...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `${publicConfig.siteUrl}/${locale}/country/${slug}`,
...
export default async function CountryPage({
  ...
  // JSON-LD
  const canonicalUrl = `${publicConfig.siteUrl}/${locale}/country/${slug}`;
  const breadcrumbLd = buildBreadcrumbListLd([
    { name: t("home"), url: `${publicConfig.siteUrl}/${locale}` },
    { name: "Countries", url: `${publicConfig.siteUrl}/${locale}/creators` },
