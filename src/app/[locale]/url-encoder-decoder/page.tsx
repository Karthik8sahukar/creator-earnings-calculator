...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { type: "website", title: "URL Encoder and Decoder Online", description: "Encode and decode URLs locally. Free and private.", url: `${publicConfig.siteUrl}/${locale}${PATH}`, siteName: publicConfig.siteName, locale },
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <>
      ...
      <ToolSEO locale={locale} pathSuffix={PATH} toolName="URL Encoder/Decoder" toolDescription="Browser-based URL encoding and decoding with full URI and component modes." faq={FAQ} breadcrumbName="URL Encoder/Decoder" />
    </>
  );
}
