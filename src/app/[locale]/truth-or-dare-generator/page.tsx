...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { type: "website", title: "Truth or Dare Generator — Free Party Game Questions", description: "Generate truth or dare questions for any occasion. 9 categories, 4 difficulty levels.", url: `${publicConfig.siteUrl}/${locale}${PATH}`, siteName: publicConfig.siteName, locale },
