...
export async function generateMetadata({
  ...
  return {
    title,
    description,
    alternates: buildAlternates({ locale, pathSuffix: "/youtube-merch-calculator" }),
    openGraph: { title, description, url: `/${locale}/youtube-merch-calculator` },
  };
}
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <SimpleCalcLayout
      ...
      breadcrumbs={[{ label: "Merch calculator", href: "/youtube-merch-calculator" }]}
      faq={[
