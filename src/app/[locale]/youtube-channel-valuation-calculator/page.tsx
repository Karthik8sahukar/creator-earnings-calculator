...
export async function generateMetadata({
  ...
  return {
    title,
    description,
    alternates: buildAlternates({ locale, pathSuffix: "/youtube-channel-valuation-calculator" }),
    openGraph: { title, description, url: `/${locale}/youtube-channel-valuation-calculator` },
  };
}
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <SimpleCalcLayout
      ...
      breadcrumbs={[{ label: "Channel valuation", href: "/youtube-channel-valuation-calculator" }]}
      faq={[
