...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <>
      ...
      <ToolSEO locale={locale} pathSuffix={PATH} toolName="YouTube Channel Valuation Calculator" toolDescription="Estimate the market value of a YouTube channel based on revenue, subscribers, and growth rate." applicationCategory="FinanceApplication" faq={FAQ} breadcrumbName="Channel Valuation Calculator" />
    </>
  );
}
