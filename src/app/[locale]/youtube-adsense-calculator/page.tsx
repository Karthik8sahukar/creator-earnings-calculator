...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <>
      ...
      <ToolSEO locale={locale} pathSuffix={PATH} toolName="YouTube AdSense Revenue Calculator" toolDescription="Estimate YouTube AdSense revenue from monthly views, RPM, and monetization percentage." applicationCategory="FinanceApplication" faq={FAQ} breadcrumbName="AdSense Calculator" />
    </>
  );
}
