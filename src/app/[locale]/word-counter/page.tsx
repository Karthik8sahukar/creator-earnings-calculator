...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { type: "website", title: "Word Counter — Free Online Word & Keyword Density Tool", description: "Count words, analyze keyword density, and estimate reading time.", url: `${publicConfig.siteUrl}/${locale}${PATH}`, siteName: publicConfig.siteName, locale },
