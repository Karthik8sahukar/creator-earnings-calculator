...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { type: "website", title: "Regex Tester – Test JavaScript Regular Expressions", description: "Test regex patterns locally with live highlights.", url: `${publicConfig.siteUrl}/${locale}${PATH}`, siteName: publicConfig.siteName, locale },
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <>
      ...
      <ToolSEO locale={locale} pathSuffix={PATH} toolName="Regex Tester" toolDescription="Browser-based JavaScript regex tester with live match highlighting and replacement." faq={FAQ} breadcrumbName="Regex Tester" />
    </>
  );
}
