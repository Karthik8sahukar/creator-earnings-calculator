...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { type: "website", title: "Random Name Picker — Pick Names From a List Free", description: "Randomly pick one or more names from your list.", url: `/${locale}${PATH}`, siteName: publicConfig.siteName, locale },
