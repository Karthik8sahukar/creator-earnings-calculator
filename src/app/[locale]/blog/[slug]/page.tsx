...
export async function generateMetadata({
  ...
  const alternates = buildAlternates({ locale, pathSuffix: canonicalSuffix });
...
export default async function BlogArticlePage({
  ...
  const shareUrl = `${publicConfig.siteUrl}/${locale}/blog/${post.slug}`;
      ...
      itemListElement: [
        {
          ...
          item: `${publicConfig.siteUrl}/${locale}`,
        },
        {
          "@type": "ListItem",
          position: 2,
          name: t("meta.breadcrumbBlog"),
          item: `${publicConfig.siteUrl}/${locale}/blog`,
        },
        {
          "@type": "ListItem",
          position: 3,
