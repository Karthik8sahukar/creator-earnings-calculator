...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: buildAlternates({ locale, pathSuffix: `/creators/${category}` }),
    openGraph: {
      title,
      description: cat.description,
      url: `${publicConfig.siteUrl}/${locale}/creators/${category}`,
...
export default async function CategoryPage({
  ...
  const breadcrumbLd = buildBreadcrumbListLd([
    ...
    { name: cat.label, url: `${base}/${locale}/creators/${category}` },
  ]);
