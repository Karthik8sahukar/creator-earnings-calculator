...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <>
      ...
      <ToolSEO locale={locale} pathSuffix={PATH} toolName="YouTube Affiliate Revenue Calculator" toolDescription="Estimate YouTube affiliate marketing revenue based on views, CTR, conversion rate, and commission." applicationCategory="FinanceApplication" faq={FAQ} breadcrumbName="Affiliate Calculator" />
    </>
  );
}
