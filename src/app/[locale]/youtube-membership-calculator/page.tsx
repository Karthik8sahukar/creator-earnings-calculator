...
const PATH = "/youtube-membership-calculator";
const FAQ = [
  ...
  return (
    <>
      <SimpleCalcLayout
        ...
        breadcrumbs={[{ label: "Membership calculator", href: PATH }]}
        faq={FAQ}
      >
        <MembershipCalcClient />
      </SimpleCalcLayout>
      <ToolSEO locale={locale} pathSuffix={PATH} toolName="YouTube Membership Revenue Calculator" toolDescription="Estimate YouTube channel membership revenue based on subscribers, conversion rate, and pricing tiers." applicationCategory="FinanceApplication" faq={FAQ} breadcrumbName="Membership Calculator" />
    </>
  );
}
