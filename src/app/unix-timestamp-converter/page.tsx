...
export default async function Page({ params }: { /* no params */ }) {
  return (
    <>
      ...
      <ToolSEO pathSuffix={PATH} toolName="Unix Timestamp Converter" toolDescription="Browser-based Unix timestamp converter with auto-detection, multiple formats, and live current time display." faq={FAQ} breadcrumbName="Unix Timestamp Converter" />
    </>
  );
}
