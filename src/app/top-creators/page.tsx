...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title,
    description,
    alternates: buildAlternates({ pathSuffix: "/top-creators" }),
    openGraph: { title, description, url: `${publicConfig.siteUrl}/top-creators`, siteName: publicConfig.siteName, type: "website" },
